<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"0px 0px 0","margin":"0px auto 0","borderColor":"#374f45","overflow":"hidden","background":"none","borderWidth":"0 0 4px","display":"block","width":"calc(100% - 60px)","fontSize":"14px","borderStyle":"solid","height":"auto"}'>
